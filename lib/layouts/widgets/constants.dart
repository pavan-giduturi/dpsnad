...
class Constants {
  ...
  static String addVoterHeader = "Add Voter ID";
  static String changePasswordHeader = "Change Password";
  ...
  static String registeronText = "Your have successfully Submitted";
  ...
  static Color buttonRed = const Color(0xFFda291c);
  ...
  static Color dpsColor = const Color(0xFF00743F);
  ...
  static String getstartedImage = "assets/images/get_started.png";
